...
export default function SplashScreen() {
  ...
  useEffect(() => {
    if (pathname === "/login" || pathname?.startsWith("/schedule")) {
      setShow(false);
      return;
    }
  ...
  if (!show || pathname === "/login" || pathname?.startsWith("/schedule")) {
    return null;
  }

  return (
    <div
      className={`fixed inset-0 z-[9999] flex flex-col items-center justify-between bg-gradient-to-b from-[#FFA14A] via-[#FF7A00] to-[#E65100] transition-opacity duration-500 ease-in-out select-none ${
